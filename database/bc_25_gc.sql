...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`company` (
  ...
  CONSTRAINT `fk_company_city1` FOREIGN KEY (`city_id`) REFERENCES `bc_25_gc`.`city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`company_job` (
  ...
  CONSTRAINT `fk_company_has_role_company` FOREIGN KEY (`company_id`) REFERENCES `bc_25_gc`.`company` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_company_has_role_role1` FOREIGN KEY (`job_id`) REFERENCES `bc_25_gc`.`job` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`skills_required` (
  ...
  CONSTRAINT `fk_role_has_skill_role1` FOREIGN KEY (`job_id`) REFERENCES `bc_25_gc`.`job` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_role_has_skill_skill1` FOREIGN KEY (`skill_id`) REFERENCES `bc_25_gc`.`skill` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`company_commute` (
  ...
  CONSTRAINT `fk_route_options_has_company_roles_route_options1` FOREIGN KEY (`commute_id`) REFERENCES `bc_25_gc`.`commute` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_role_routes_company1` FOREIGN KEY (`company_id`) REFERENCES `bc_25_gc`.`company` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`user_skills` (
  ...
  CONSTRAINT `fk_user_has_skill_user1` FOREIGN KEY (`user_id`) REFERENCES `bc_25_gc`.`user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_skill_skill1` FOREIGN KEY (`skill_id`) REFERENCES `bc_25_gc`.`skill` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`user_city` (
  ...
  CONSTRAINT `fk_user_has_city_user1` FOREIGN KEY (`user_id`) REFERENCES `bc_25_gc`.`user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_city_city1` FOREIGN KEY (`city_id`) REFERENCES `bc_25_gc`.`city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`saved_jobs` (
  ...
  CONSTRAINT `fk_user_has_company_job_user1` FOREIGN KEY (`user_id`) REFERENCES `bc_25_gc`.`user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_company_job_company_job1` FOREIGN KEY (`company_job_id`) REFERENCES `bc_25_gc`.`company_job` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bc_25_gc`.`applied_jobs` (
  ...
  CONSTRAINT `fk_company_job_has_user_company_job1` FOREIGN KEY (`company_job_id`) REFERENCES `bc_25_gc`.`company_job` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_company_job_has_user_user1` FOREIGN KEY (`user_id`) REFERENCES `bc_25_gc`.`user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
